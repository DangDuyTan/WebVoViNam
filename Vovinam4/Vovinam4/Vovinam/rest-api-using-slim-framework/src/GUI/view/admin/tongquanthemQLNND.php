...
<body>
                ...
                <div class="form-container">
                    ...
                    <form action="" class="permission-form">
                        <div class="form-group">
                            <label for="maQuyen">Mã nhóm người dùng mới:</label>
                            <input type="text" id="maQuyen" class="form-control" required>
                            <label for="tenQuyen">Tên nhóm người dùng mới:</label>
                            <input type="text" id="tenQuyen" class="form-control" required>

                        </div>
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary" onclick="addObj(event)">Thêm nhóm người
                                dùng</button>
    ...
    <script src="../../Js/admin/ThemNhomNguoiDung.js?v=<?php echo $version ?>"></script>
