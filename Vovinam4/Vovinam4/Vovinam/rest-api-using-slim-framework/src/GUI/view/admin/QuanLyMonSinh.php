...
<body>
    <div class="container-sb">
        ...
        <div class="content">
            ...
            <div class="content-page">
                <div>
                    <h1>QUẢN LÝ MÔN SINH</h1>
                    <a href="./ThemMonSinh.php" class=" add-new"><i class="fa fa-plus"></i> Thêm
                        môn sinh mới</a>
                </div>
                <div class="tim-kiem">
                    <form action="QuanLyMonSinh.php" method="get">
    ...
    <script src="../../Js/admin/QuanLyMonSinh.js?v=<?php echo $version ?>"></script>
