...
<body>
        ...
        <div class="content">
            ...
            <div class="content-page">
                <div>
                    ...
                    <a href="#" onclick="addObj(event)" class="add-new"><i class="fa fa-plus"></i> Thêm khóa thi mới</a>
                </div>
                <div class="tim-kiem">
                    <form action="QuanLyKhoaThi.php" method="get">
                        <input type="text" name="tenTimKiem" id="input-search-account" placeholder="Nhập dữ liệu tìm kiếm khóa thi">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-dan    ger btn-confirm-delete">Xóa</button>
                    </div>
                </div>
            </div>
        </div> -->
    ...
    <script src="../../Js/admin/QuanLyKhoaThi.js?v=<?php echo $version ?>"></script>
