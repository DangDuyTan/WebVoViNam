...
<body>
            ...
            <div class="content-page">
                ...
                <div class="tim-kiem">
                    <form action="TongquanQLNND.php" method="get">
                        <input type="text" name="tenTimKiem" id="input-search-accountgroup"
                            placeholder="Nhập dữ liệu tìm kiếm nhóm người dùng">
                    ...
                    <div class="modal-body">
                        <form id="editForm">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nndCode" name="nndCode" value="admin"
                                    disabled>
                            </div>
                            <div class="mb-3">
                                <label for="sizeName" class="form-label">Tên Nhóm Người Dùng</label>
                                <input type="text" class="form-control" id="nndName" name="nndName"
                                    value="Quyền quản trị admin">
                            </div>
    ...
    <script src="../../Js/admin/QuanLyNhomNguoiDung.js?v=<?php echo $version ?>"></script>
