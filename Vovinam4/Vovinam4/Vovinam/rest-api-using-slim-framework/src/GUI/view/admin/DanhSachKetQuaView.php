...
<?php require('../../../config.php') ?>
  ...
  <body>
    ...
    <div class="contain_sb" ib="contain_sb ">
        <div class="side-bar">
        ...
        <div class = "content">
            ...
            <div class="content-select">
                ...
                <div class="tim-kiem">
                <form id="searchForm" method="GET" action="DanhSachKetQuaView.php">
                ...
                <div class="sle_op">
                        ...
                        <div class="flex-1">
                            <label for="clb" class="block_text">Câu lạc bộ:</label>
                            <select id="clb" class="sle_op.option" name = "clb">
    ...
    <script src="../../Js/admin/DSKQ.js?v=<?php echo $version ?>"></script>
