            ...
            <div class="content-page">
                ...
                <!-- <div class="filter-chart">
                    <div class="filter">
                        ...
                        <div style="cursor: pointer;" id="buttonSearch" onclick="ThongKe()" class="buttonSearch">Thống
                            kê <div class="button">Thống kê</div>
                        </div>
                    </div>
                    <div class="chart">
                        <div class="pie-chart">
                ...
                <ul class="pagination pagination-sm justify-content-end mt-5" id="Pagination"
